...
import { autonomouslyApproveAndRequestAgent, pollActiveAgents, pollActivePullRequests } from "@/lib/autoapp/execute";
...
async function observe() {
  try {
    ...
    return NextResponse.json({ ...result, polledAgents, polledPullRequests });
  } catch (error) {
